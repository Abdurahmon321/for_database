...
urlpatterns = [
    ...
    path('admin-add-teacher', views.add_teacher, name="admin-add-teacher"),
    path('admin-add-student', views.add_student, name="admin-add-student"),
    ...
    path('edit-question/<int:pk>', views.update_question, name="edit-question"),
